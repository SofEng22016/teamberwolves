  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-university"></i><span>Faculty</span></a></li>
        <li><a href="#"><i class="fa fa-user"></i><span>Students</span></a></li>
        <li><a href="#"><i class="fa fa-users"></i><span>Guests</span></a></li>
        <li><a href="#"><i class="fa fa-folder-open-o"></i><span>Applications</span></a></li>
        <li><a href="#"><i class="fa fa-book"></i><span>Subjects</span></a></li>
        <li><a href="#"><i class="fa fa-file-text-o"></i><span>Curriculum</span></a></li>
        <li><a href="#"><i class="fa fa-money"></i><span>Finance</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript::;">
              <i class="menu-icon fa fa-tv bg-red"></i>

              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Insert PHP Codes</h4>

                <p>Deadline Sprint 4</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript::;">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Design Page</h4>
